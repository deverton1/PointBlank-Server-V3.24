...
namespace PointBlank.Battle.Data.Configs
{
  public static class BattleConfig
  {
    ...
    public static void Load()
    {
      ...
      BattleConfig.dbName = configFile1.readString("Name", "pointblank24");
      BattleConfig.dbUser = configFile1.readString("User", "postgres");
      BattleConfig.dbPass = configFile1.readString("Pass", "1234");
      BattleConfig.dbPort = configFile1.readInt32("Port", 5432);
      ...
      BattleConfig.hosIp = configFile2.readString("UdpIp", "127.0.0.1");
      BattleConfig.serverIp = configFile2.readString("ServerIp", "127.0.0.1");
