    ...
    private static void AcceptCallback(IAsyncResult res)
    {
      ...
      GameSync.LoadPacket(buffer);
        ...
        private static bool PacketCheckGameSync(short uint16)
        {
            ...
            else if (uint16 == 100) { return true; }
            else if (uint16 == 102) { return true; }
            else { return false; }
        }
          ...
          case 13:
            ...
            break;
                    case 15:
                            ...
                            int id3 = p.readD();
                            int lastCount = p.readD();
                            GameServerModel server1 = ServersXml.getServer(id3);
                            if (server1 != null)
                            {
                                server1._LastCount = lastCount;
