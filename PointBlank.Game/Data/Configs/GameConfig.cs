...
namespace PointBlank.Game.Data.Configs
{
    public static class GameConfig
    {
        ...
        public static void Load()
        {
            ...
            Config.dbName = configFile1.readString("Name", "pointblank24");
            Config.dbUser = configFile1.readString("User", "postgres");
            Config.dbPass = configFile1.readString("Pass", "1234");
            Config.dbPort = configFile1.readInt32("Port", 5432);
            ...
            gameIp = configFile2.readString("GameIp", "0.0.0.0");
