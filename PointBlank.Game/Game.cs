...
namespace PointBlank.Game
{
  public static class Game
  {
    ...
    public static async void Update()
    {
      while (true)
      {
        Console.Title = "[MT]GAME [S]: " + GameManager._socketList.Count.ToString() + " [O]: " + ServersXml.getServer(GameConfig.serverId)._LastCount.ToString() + " [R]: " + (GC.GetTotalMemory(true) / 1024L).ToString() + " KB]";
