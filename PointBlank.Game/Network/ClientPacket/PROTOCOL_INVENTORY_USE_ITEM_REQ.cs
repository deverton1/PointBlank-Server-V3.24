    ...
    private void CreateCouponEffects(int cupomId, long cuponDays, PointBlank.Game.Data.Model.Account p)
    {
      switch (cupomId)
      {
        ...
        case 1600010:
          ...
          break;
        case 1600183:
                 using (PROTOCOL_BASE_MEGAPHONE_ACK megaPhone = new PROTOCOL_BASE_MEGAPHONE_ACK(p.player_name, this.txt))
                 {
                      GameManager.SendPacketToAllClients((SendPacket)megaPhone);
                 }
