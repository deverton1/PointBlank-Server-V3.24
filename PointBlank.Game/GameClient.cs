...
namespace PointBlank.Game
{
    public class GameClient : IDisposable
    {
        ...
        private bool closed;
        public TimerState CheckSock = new TimerState();
        ...
        private void RunPacket(byte[] buff, byte[] simple)
        {
            ...
            if (!firstPacketId)
            {
                if(!this.FirstPacketCheck(uint16)){
                    string msg = GetIPAddress() + "Primeiro pacote nao recebido [" + uint16.ToString() + "]";
                    Logger.warning(msg);
            ...
            switch (uint16)
            {
                ...
                case 6963:
                    ...
                    break;
                case 6557:
                    receivePacket = new PROTOCOLA_BASE_GAME_UNDEFINED_REQ(this, buff);
                    break;
                case 7429:
